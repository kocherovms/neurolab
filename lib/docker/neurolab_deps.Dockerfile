...
RUN pip install --break-system-packages --no-cache-dir ale_py==0.12.0+neurolab7 --index-url=http://nexus:8081/repository/neurolab-pypi/simple --trusted-host=nexus
CMD ["/bin/bash"]
